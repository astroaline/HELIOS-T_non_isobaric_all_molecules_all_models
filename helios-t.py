...
with open('/home/aline/Desktop/PhD/HELIOS-T-master_[non_isobaric_new_version_all_molecules_all_models]/planets/'+planet_name+'/retrieved_results_'+planet_name+'_non_isobaric_'+model_name+'.txt', 'w') as save_retrieved_results:
    for param in parameters:
...
fig.savefig('/home/aline/Desktop/PhD/HELIOS-T-master_[non_isobaric_new_version_all_molecules_all_models]/planets/'+planet_name+'/cornerplot_'+planet_name+'_non_isobaric_'+model_name+'.png', format='png')
fig.savefig('/home/aline/Desktop/PhD/HELIOS-T-master_[non_isobaric_new_version_all_molecules_all_models]/planets/'+planet_name+'/cornerplot_'+planet_name+'_non_isobaric_'+model_name+'.eps', format='eps')
